  ...
  return (
    <section aria-labelledby="problem-title" className="bg-canvas py-24 sm:py-32 transition-colors duration-200">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <SectionHeading
          id="problem-title"
          title="Healthcare operations shouldn't feel this fragmented."
          description="Eight teams, eight tools, and nothing shared between them. H.O.L.E. APP puts them on one system."
          align="center"
        />
          ...
          <Reveal>
            <div
              ...
              style={{
                ...
                color: "var(--tw-line, rgba(120,120,120,0.18))",
              }}
            >
              <div
                className="absolute left-4 top-4 z-20 inline-flex rounded-xl bg-canvas p-1 ring-1 ring-line"
                role="group"
              ...
              <svg className="absolute inset-0 h-full w-full" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden>
                {connected
                  ...
                  : brokenPairs.map(([a, b]) => {
                      ...
                      return (
                        <g key={`${a}-${b}`} stroke="currentColor" strokeWidth="1.2" strokeDasharray="3 4" className="text-ink-subtle/50">
              ...
              <div className="absolute left-1/2 top-1/2 z-10 -translate-x-1/2 -translate-y-1/2">
                <motion.div
                  ...
                  className="grid h-32 w-32 place-items-center rounded-3xl bg-surface p-3 text-center shadow-card border border-brand/40 ring-4 ring-brand/10 transition-colors duration-200"
                >
                  <div className="flex flex-col items-center">
                    <Logo imgClassName="h-12 w-auto object-contain select-none" />
                    <span className="mt-1 text-[10px] font-bold text-brand-ink dark:text-brand tracking-wider uppercase">One System</span>
                  </div>
                </motion.div>
              </div>
              ...
              <motion.div
                ...
                className="absolute bottom-4 right-4 z-20 flex items-center gap-1.5 rounded-lg bg-canvas px-2.5 py-1.5 text-[11px] font-medium text-ink-muted ring-1 ring-line shadow-sm"
              >
              ...
              {fragmentedNodes.map(({ label, icon: Icon, x, y }, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <Icon className={`h-3.5 w-3.5 ${connected ? "text-brand-ink dark:text-brand" : "text-ink-subtle"}`} aria-hidden />
                      {label}
                    </div>
                  </motion.div>
                );
