              ...
              {[
                ...
                map((o) =>
                  <button
                    ...
                    className={`whitespace-nowrap rounded-lg px-3 py-1.5 text-xs font-semibold transition-[background-color,color] duration-150 ${connected === o.value ? "bg-surface text-ink shadow-card" : "text-ink-muted hover:text-ink"}`
                    }>
            ...
            {fragmentedNodes.map(({ label, icon: Icon, x, y }, i) => {
              ...
              return (
                <motion.div
                  ...
                  <div
                    className={`flex -translate-x-1/2 -translate-y-1/2 items-center gap-2 whitespace-nowrap rounded-xl border bg-surface px-3 py-2 text-xs font-semibold shadow-card transition-[border-color,color] duration-200 ${connected ? "border-brand-line text-ink" : "border-line text-ink-muted"}`
                    }>
